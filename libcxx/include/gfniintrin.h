...
#define _mm_maskgf2p8affineinv_epi64_epi8(U, A, B, I) \
...
#define _mm256_maskgf2p8affineinv_epi64_epi8(U, A, B, I) \
...
#define _mm512_maskgf2p8affineinv_epi64_epi8(U, A, B, I) \
...
#define _mm_maskgf2p8affine_epi64_epi8(U, A, B, I) \
...
#define _mm256_maskgf2p8affine_epi64_epi8(U, A, B, I) \
...
#define _mm512_maskgf2p8affine_epi64_epi8(U, A, B, I) \
...
static __inline__ __m128i __DEFAULT_FN_ATTRS_VL128
_mm_maskgf2p8mul_epi8(__mmask16 __U, __m128i __A, __m128i __B)
{
...
static __inline__ __m256i __DEFAULT_FN_ATTRS_VL256
_mm256_maskgf2p8mul_epi8(__mmask32 __U, __m256i __A, __m256i __B)
{
...
static __inline__ __m512i __DEFAULT_FN_ATTRS_Z
_mm512_maskgf2p8mul_epi8(__mmask64 __U, __m512i __A, __m512i __B)
{
