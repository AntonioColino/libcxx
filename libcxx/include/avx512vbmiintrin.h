...
static __inline__ __m512i __DEFAULT_FN_ATTRS
_mm512_maskpermutex2var_epi8(__mmask64 __U, __m512i __A, __m512i __I,
                               __m512i __B)
{
  return (__m512i)__builtin_ia32_selectb_512(__U,
                               (__v64qi)_mm512_permutex2var_epi8(__A, __I, __B),
...
static __inline__ __m512i __DEFAULT_FN_ATTRS
_mm512_maskpermutexvar_epi8 (__mmask64 __M, __m512i __A,
        __m512i __B)
{
...
static __inline__ __m512i __DEFAULT_FN_ATTRS
_mm512_maskmultishift_epi64_epi8(__mmask64 __M, __m512i __X, __m512i __Y)
{
  return (__m512i)__builtin_ia32_selectb_512((__mmask64)__M,
                                (__v64qi)_mm512_multishift_epi64_epi8(__X, __Y),
                                (__v64qi)_mm512_setzero_si512());
