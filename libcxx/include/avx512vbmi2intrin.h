...
static __inline__ __m512i __DEFAULT_FN_ATTRS
_mm512_maskcompress_epi16(__mmask32 __U, __m512i __D)
{
  return (__m512i) __builtin_ia32_compresshi512_mask ((__v32hi) __D,
...
static __inline__ __m512i __DEFAULT_FN_ATTRS
_mm512_maskcompress_epi8(__mmask64 __U, __m512i __D)
{
  return (__m512i) __builtin_ia32_compressqi512_mask ((__v64qi) __D,
...
static __inline__ __m512i __DEFAULT_FN_ATTRS
_mm512_maskexpand_epi16(__mmask32 __U, __m512i __D)
{
  return (__m512i) __builtin_ia32_expandhi512_mask ((__v32hi) __D,
              (__v32hi) _mm512_setzero_si512(),
              __U);
...
static __inline__ __m512i __DEFAULT_FN_ATTRS
_mm512_maskexpand_epi8(__mmask64 __U, __m512i __D)
{
  return (__m512i) __builtin_ia32_expandqi512_mask ((__v64qi) __D,
              (__v64qi) _mm512_setzero_si512(),
              __U);
...
static __inline__ __m512i __DEFAULT_FN_ATTRS
_mm512_maskexpandloadu_epi16(__mmask32 __U, void const *__P)
{
  return (__m512i) __builtin_ia32_expandloadhi512_mask ((const __v32hi *)__P,
              (__v32hi) _mm512_setzero_si512(),
              __U);
...
static __inline__ __m512i __DEFAULT_FN_ATTRS
_mm512_maskexpandloadu_epi8(__mmask64 __U, void const *__P)
{
  return (__m512i) __builtin_ia32_expandloadqi512_mask ((const __v64qi *)__P,
              (__v64qi) _mm512_setzero_si512(),
              __U);
...
#define _mm512_maskshldi_epi64(U, A, B, I) \
  (__m512i)__builtin_ia32_selectq_512((__mmask8)(U), \
                                    (__v8di)_mm512_shldi_epi64((A), (B), (I)), \
...
#define _mm512_maskshldi_epi32(U, A, B, I) \
  (__m512i)__builtin_ia32_selectd_512((__mmask16)(U), \
                                   (__v16si)_mm512_shldi_epi32((A), (B), (I)), \
...
#define _mm512_maskshldi_epi16(U, A, B, I) \
  (__m512i)__builtin_ia32_selectw_512((__mmask32)(U), \
                                   (__v32hi)_mm512_shldi_epi16((A), (B), (I)), \
                                   (__v32hi)_mm512_setzero_si512())
...
#define _mm512_maskshrdi_epi64(U, A, B, I) \
  (__m512i)__builtin_ia32_selectq_512((__mmask8)(U), \
                                    (__v8di)_mm512_shrdi_epi64((A), (B), (I)), \
                                    (__v8di)_mm512_setzero_si512())
...
#define _mm512_maskshrdi_epi32(U, A, B, I) \
  (__m512i)__builtin_ia32_selectd_512((__mmask16)(U), \
                                   (__v16si)_mm512_shrdi_epi32((A), (B), (I)), \
                                   (__v16si)_mm512_setzero_si512())
...
#define _mm512_maskshrdi_epi16(U, A, B, I) \
  (__m512i)__builtin_ia32_selectw_512((__mmask32)(U), \
                                   (__v32hi)_mm512_shrdi_epi16((A), (B), (I)), \
                                   (__v32hi)_mm512_setzero_si512())
...
static __inline__ __m512i __DEFAULT_FN_ATTRS
_mm512_maskshldv_epi64(__mmask8 __U, __m512i __A, __m512i __B, __m512i __C)
{
  return (__m512i)__builtin_ia32_selectq_512(__U,
                                      (__v8di)_mm512_shldv_epi64(__A, __B, __C),
                                      (__v8di)_mm512_setzero_si512());
...
static __inline__ __m512i __DEFAULT_FN_ATTRS
_mm512_maskshldv_epi32(__mmask16 __U, __m512i __A, __m512i __B, __m512i __C)
{
  return (__m512i)__builtin_ia32_selectd_512(__U,
                                     (__v16si)_mm512_shldv_epi32(__A, __B, __C),
                                     (__v16si)_mm512_setzero_si512());
...
static __inline__ __m512i __DEFAULT_FN_ATTRS
_mm512_maskshldv_epi16(__mmask32 __U, __m512i __A, __m512i __B, __m512i __C)
{
  return (__m512i)__builtin_ia32_selectw_512(__U,
                                     (__v32hi)_mm512_shldv_epi16(__A, __B, __C),
                                     (__v32hi)_mm512_setzero_si512());
...
static __inline__ __m512i __DEFAULT_FN_ATTRS
_mm512_maskshrdv_epi64(__mmask8 __U, __m512i __A, __m512i __B, __m512i __C)
{
  return (__m512i)__builtin_ia32_selectq_512(__U,
                                      (__v8di)_mm512_shrdv_epi64(__A, __B, __C),
                                      (__v8di)_mm512_setzero_si512());
...
static __inline__ __m512i __DEFAULT_FN_ATTRS
_mm512_maskshrdv_epi32(__mmask16 __U, __m512i __A, __m512i __B, __m512i __C)
{
  return (__m512i) __builtin_ia32_selectd_512(__U,
                                     (__v16si)_mm512_shrdv_epi32(__A, __B, __C),
                                     (__v16si)_mm512_setzero_si512());
...
static __inline__ __m512i __DEFAULT_FN_ATTRS
_mm512_maskshrdv_epi16(__mmask32 __U, __m512i __A, __m512i __B, __m512i __C)
{
  return (__m512i)__builtin_ia32_selectw_512(__U,
                                     (__v32hi)_mm512_shrdv_epi16(__A, __B, __C),
                                     (__v32hi)_mm512_setzero_si512());
