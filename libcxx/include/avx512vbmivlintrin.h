...
static __inline__ __m128i __DEFAULT_FN_ATTRS128
_mm_maskpermutex2var_epi8(__mmask16 __U, __m128i __A, __m128i __I,
                            __m128i __B)
{
  return (__m128i)__builtin_ia32_selectb_128(__U,
                                  (__v16qi)_mm_permutex2var_epi8(__A, __I, __B),
...
static __inline__ __m256i __DEFAULT_FN_ATTRS256
_mm256_maskpermutex2var_epi8(__mmask32 __U, __m256i __A, __m256i __I,
                               __m256i __B)
{
  return (__m256i)__builtin_ia32_selectb_256(__U,
                               (__v32qi)_mm256_permutex2var_epi8(__A, __I, __B),
...
static __inline__ __m128i __DEFAULT_FN_ATTRS128
_mm_maskpermutexvar_epi8 (__mmask16 __M, __m128i __A, __m128i __B)
{
...
static __inline__ __m256i __DEFAULT_FN_ATTRS256
_mm256_maskpermutexvar_epi8 (__mmask32 __M, __m256i __A,
        __m256i __B)
{
...
static __inline__ __m128i __DEFAULT_FN_ATTRS128
_mm_maskmultishift_epi64_epi8(__mmask16 __M, __m128i __X, __m128i __Y)
{
  return (__m128i)__builtin_ia32_selectb_128((__mmask16)__M,
                                   (__v16qi)_mm_multishift_epi64_epi8(__X, __Y),
                                   (__v16qi)_mm_setzero_si128());
...
static __inline__ __m256i __DEFAULT_FN_ATTRS256
_mm256_maskmultishift_epi64_epi8(__mmask32 __M, __m256i __X, __m256i __Y)
{
  return (__m256i)__builtin_ia32_selectb_256((__mmask32)__M,
                                (__v32qi)_mm256_multishift_epi64_epi8(__X, __Y),
                                (__v32qi)_mm256_setzero_si256());
